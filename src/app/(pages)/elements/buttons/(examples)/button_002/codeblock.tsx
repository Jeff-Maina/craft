  ...
  return (
    <button className="h-12 px-4 pr-7 rounded-full bg-[#2a2a2a] flex items-center justify-center gap-2 group/button outline-blue-500 active:bg-black">
      <div className="relative size-5 rounded-full overflow-hidden">
        ...
        <ArrowRight className="h-[16px] w-[16px] absolute top-2/4 left-2/4 -translate-x-[150%] group-hover/button:-translate-x-2/4 group-active/button:-translate-x-1/4 -translate-y-2/4 transition-all duration-200" />
      </div>
